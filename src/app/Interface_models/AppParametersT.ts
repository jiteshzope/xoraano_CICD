import { CityParametersT } from "./CityParametersT";
import { DisplayFoodItemT } from "./DisplayFoodItemT";

export interface AppParametersT {

    alertMsg : string;
    casual_coupon_code : string;
    checkout_image_url : string;
    CityParameters : CityParametersT;
    cod_available : string;
    del_boy : string;
    displayFoodItems : DisplayFoodItemT[];
    eula : string;
